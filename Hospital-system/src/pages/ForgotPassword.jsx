...
import { KeyRound, User, IdCard, Send, ArrowLeft, CheckCircle, AlertCircle, Shield } from 'lucide-react';
...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.username.trim() || !formData.employeeNumber.trim()) {
    ...
    return (
        <div className={`min-h-screen w-screen relative overflow-x-hidden ${
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className={`absolute top-3/4 right-1/4 w-96 h-96 bg-gradient-to-r ${
                    userType === 'admin' 
                ...
                <div className="w-full max-w-md mx-auto">
                    <div className="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-6 lg:p-8">
                        ...
                        <div className="text-center mb-6 lg:mb-8">
                            ...
                            <h2 className="text-2xl lg:text-3xl font-bold text-white mb-2">Forgot Password</h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <IdCard className={`absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 ${
                                        userType === 'admin' ? 'text-purple-400' : 'text-cyan-400'
                                    }`} />
                                    <input
                                        type="text"
                            ...
                            <div className="text-center">
                                <button 
                                    ...
                                    className={`${
                                        userType === 'admin' ? 'text-purple-400 hover:text-purple-300' : 'text-cyan-400 hover:text-cyan-300'
                            ...
                            <div className="text-center mt-6">
                                <div className={`inline-flex items-center px-3 py-2 backdrop-blur-sm rounded-lg border ${
                                    userType === 'admin'
                                        ? 'bg-purple-500/20 border-purple-400/30'
                                        : 'bg-green-500/20 border-green-400/30'
                                }`}>
                                    <Shield className={`w-4 h-4 mr-2 ${
                                        userType === 'admin' ? 'text-purple-400' : 'text-green-400'
                                    }`} />
                                    <span className={`text-xs ${
                                        userType === 'admin' ? 'text-purple-300' : 'text-green-300'
                                    }`}>
